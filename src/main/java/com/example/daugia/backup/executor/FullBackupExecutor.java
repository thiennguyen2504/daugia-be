...
@Component
public class FullBackupExecutor extends AbstractBackupExecutor {

    public FullBackupExecutor(BackupStorageProvider storageProvider, BackupProcessExecutor processExecutor) {
