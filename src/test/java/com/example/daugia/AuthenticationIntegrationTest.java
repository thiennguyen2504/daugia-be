...
class AuthenticationIntegrationTest {
        ...
        @Autowired
        private com.example.daugia.repository.UserRepository userRepository;

        @Autowired
        private com.example.daugia.repository.RoleRepository roleRepository;
        ...
        public void setUp() {
                ...
                if (roleRepository.findByName("ADMIN").isEmpty()) {
                        roleRepository.save(com.example.daugia.entity.Role.builder().name("ADMIN").build());
                }
                if (roleRepository.findByName("USER").isEmpty()) {
                        roleRepository.save(com.example.daugia.entity.Role.builder().name("USER").build());
                }
